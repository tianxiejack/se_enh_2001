...
void CDisplayer::linkageSwitchMode(void)
{
	...
	switch(displayMode) 
	{
		...
		case PIC_IN_PIC:		
			...
			m_renders[1].displayrect.x =  vdisWH[0][0]*3/4;
			m_renders[1].displayrect.y =  vdisWH[0][1]*3/4;
			m_renders[1].displayrect.w = vdisWH[0][0]/4;
			m_renders[1].displayrect.h =  vdisWH[0][1]/4;				
