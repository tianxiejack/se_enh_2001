...
void CProcess::DrawCross(cv::Rect rec,int fcolour ,bool bShow /*= true*/)
{
	...
	Drawcvcrossaim(m_display.m_imgOsd[extInCtrl->SensorStat],&lineparm);
}
...
void CProcess::update_param_osd()
{
	...
	pIStuts->AcqRectW[4] 			= 30;   //gConfig_Osd_param.ch4_acqRect_width;
	pIStuts->AcqRectW[5] 			= 60;  //gConfig_Osd_param.ch5_acqRect_width;
	pIStuts->AcqRectH[0] 			= 60;  //gConfig_Osd_param.ch0_acqRect_height;
	pIStuts->AcqRectH[1] 			= 60;  //gConfig_Osd_param.ch1_acqRect_height;
	pIStuts->AcqRectH[2] 			= 60;  //gConfig_Osd_param.ch2_acqRect_height;
	pIStuts->AcqRectH[3] 			= 60;  //gConfig_Osd_param.ch3_acqRect_height;
	pIStuts->AcqRectH[4] 			= 60;  //gConfig_Osd_param.ch4_acqRect_height;
	pIStuts->AcqRectH[5] 			= 60;  //gConfig_Osd_param.ch5_acqRect_height;

	pIStuts->AimW[0] 			= 60;  //gConfig_Osd_param.ch0_aim_width;
	pIStuts->AimW[1] 			= 60;  //gConfig_Osd_param.ch1_aim_width;
	pIStuts->AimW[2] 			= 60;  //gConfig_Osd_param.ch2_aim_width;
	pIStuts->AimW[3] 			= 60;  //gConfig_Osd_param.ch3_aim_width;
	pIStuts->AimW[4] 			= 60;  //gConfig_Osd_param.ch4_aim_width;
	pIStuts->AimW[5] 			= 60;  //gConfig_Osd_param.ch5_aim_width;
	pIStuts->AimH[0] 				= 60;  //gConfig_Osd_param.ch0_aim_height;
	pIStuts->AimH[1] 				= 60;  //gConfig_Osd_param.ch1_aim_height;
	pIStuts->AimH[2] 				= 60;  //gConfig_Osd_param.ch2_aim_height;
	pIStuts->AimH[3] 				= 60;  //gConfig_Osd_param.ch3_aim_height;
	...
	pIStuts->crossAxisWidth 		= 60;  //gConfig_Osd_param.CROSS_AXIS_WIDTH;
	pIStuts->crossAxisHeight		= 60;  //gConfig_Osd_param.CROSS_AXIS_HEIGHT;
	pIStuts->picpCrossAxisWidth	= 60;  //gConfig_Osd_param.Picp_CROSS_AXIS_WIDTH;
	pIStuts->picpCrossAxisHeight	= 60;  //gConfig_Osd_param.Picp_CROSS_AXIS_HEIGHT;
